  ...
  const handleSolved = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        console.log("Termination annulée");
      }
    });
  };
    ...
    <div>
      <div className="relative mt-9 overflow-x-auto shadow-lg sm:rounded-lg">
          ...
          <Link
            to={
              selectedPhoneTicketIds.length === 1
                ? `/admin/field/${selectedPhoneTicketIds[0]}`
                : "#"
            }
          >
            <button
        ...
        <div className="overflow-x-auto">
                ...
                .map((fieldticket, index) => (
                  ...
                  >
                    <td className="w-4 p-4">
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={() => handleCheckboxChange(fieldticket._id)}
                        />
                        <label
                    ...
                    <td className="px-6 py-4">
                      <button
                        scope="row"
                        onClick={() => handleOpenModifyModal(fieldticket)}
          ...
          {isModifyModalOpen && <ModifyField handleClose={handleCloseModifyModal} ticket={selectedTicket} />}
